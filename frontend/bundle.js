...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/scripts/entry.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./frontend/scripts/components/App.jsx":
/*!*********************************************!*\
  !*** ./frontend/scripts/components/App.jsx ***!
  \*********************************************/
...
var _nodeElement = __webpack_require__(/*! ./nodeElement/nodeElement */ "./frontend/scripts/components/nodeElement/nodeElement.jsx");
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = { height: window.innerHeight, width: window.innerWidth };
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'section',
        null,
        Object.keys(roomMapping).map(function (room, idx) {
          return _react2.default.createElement(_nodeElement2.default, { key: roomMapping[room],
            top: '' + roomMapping[room][0],
            left: '' + roomMapping[room][1],
            data: data[room] });
        }),
        _react2.default.createElement('img', { height: this.state.height,
...
/***/ "./frontend/scripts/components/nodeElement/nodeElement.jsx":
/*!*****************************************************************!*\
  !*** ./frontend/scripts/components/nodeElement/nodeElement.jsx ***!
  \*****************************************************************/
/*! no static exports found */
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "svg",
          { height: "50", width: "50", style: { top: this.props.top + "%", left: this.props.left + "%" } },
          _react2.default.createElement("circle", { onMouseEnter: function onMouseEnter(e) {
...
/***/ "./frontend/scripts/components/root.jsx":
/*!**********************************************!*\
  !*** ./frontend/scripts/components/root.jsx ***!
  \**********************************************/
/*! no static exports found */
...
var _App = __webpack_require__(/*! ./App */ "./frontend/scripts/components/App.jsx");
...
var _root = __webpack_require__(/*! ./components/root */ "./frontend/scripts/components/root.jsx");

var _root2 = _interopRequireDefault(_root);

var _store = __webpack_require__(/*! ./store/store */ "./frontend/scripts/store/store.js");
...
/***/ "./frontend/scripts/reducers/entitiesReducer.js":
/*!******************************************************!*\
  !*** ./frontend/scripts/reducers/entitiesReducer.js ***!
  \******************************************************/
/*! no static exports found */
...
var _testReducer = __webpack_require__(/*! ./testReducer */ "./frontend/scripts/reducers/testReducer.js");

exports.default = (0, _redux.combineReducers)({
  test: _testReducer.testReducer
});

/***/ }),

/***/ "./frontend/scripts/reducers/rootReducer.js":
/*!**************************************************!*\
  !*** ./frontend/scripts/reducers/rootReducer.js ***!
  \**************************************************/
/*! no static exports found */
...
var _entitiesReducer = __webpack_require__(/*! ./entitiesReducer */ "./frontend/scripts/reducers/entitiesReducer.js");
...
/***/ "./frontend/scripts/reducers/testReducer.js":
/*!**************************************************!*\
  !*** ./frontend/scripts/reducers/testReducer.js ***!
  \**************************************************/
/*! no static exports found */
...
var testReducer = exports.testReducer = function testReducer() {
...
/***/ "./frontend/scripts/store/store.js":
/*!*****************************************!*\
  !*** ./frontend/scripts/store/store.js ***!
  \*****************************************/
/*! no static exports found */
...
var _rootReducer = __webpack_require__(/*! ../reducers/rootReducer */ "./frontend/scripts/reducers/rootReducer.js");
...
var configureStore = function configureStore() {
    ...
    return (0, _redux.createStore)(_rootReducer2.default, preloadedState, _redux.applyMiddleware.apply(undefined, middlewares));
};
...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    invariant__WEBPACK_IMPORTED_MODULE_1___default()(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + ('connect. Instead received ' + JSON.stringify(WrappedComponent)));
